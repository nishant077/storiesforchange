...
const CursorEffect = () => {
    ...
    const isMobile= typeof window !== "undefined" && window.matchMedia ("(max-width)").matches
  ...
  return (
    <>
    <div ref={cursorRef} className="fixed top-0 left-0 w-[20px] h-[20px] bg-[#0BDA51] rounded-full pointer-events-none z-[999] mix-blend-difference"/>
